...
"#,
    ...
    let html =
        unsafe { libpltxt2htm_sys::pltxt2htm_advanced_parserd(pltext.as_ptr(), host.as_ptr()) };
    #[cfg(not(debug_assertions))]
    let html =
        unsafe { libpltxt2htm_sys::pltxt2htm_advanced_parser(pltext.as_ptr(), host.as_ptr()) };
