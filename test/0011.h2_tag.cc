...
int main() {
    auto html1 = ::pltxt2htm_test::pltxt2advanced_htmld(u8"<h2>text</h2>");
    auto answer1 = ::fast_io::u8string_view{u8"<h2>text</h2>"};
    ::pltxt2htm_test::assert_true(html1 == answer1);

    auto html2 = ::pltxt2htm_test::pltxt2advanced_htmld(u8"<H2    >text</h2  >");
    auto answer2 = ::fast_io::u8string_view{u8"<h2>text</h2>"};
    ::pltxt2htm_test::assert_true(html2 == answer2);

    auto html3 = ::pltxt2htm_test::pltxt2advanced_htmld(u8"<h2><color=red>text</color></h2>");
    auto answer3 = ::fast_io::u8string_view{u8"<h2><span style=\"color:red;\">text</span></h2>"};
    ::pltxt2htm_test::assert_true(html3 == answer3);

    auto html4 = ::pltxt2htm_test::pltxt2advanced_htmld(u8"<h2><color=red>text</h2></color>");
    auto answer4 = ::fast_io::u8string_view{u8"<h2><span style=\"color:red;\">text&lt;/h2&gt;</span></h2>"};
    ::pltxt2htm_test::assert_true(html4 == answer4);

    auto html5 = ::pltxt2htm_test::pltxt2advanced_htmld(u8"<h2>text<h2>text</h2></h2>");
    auto answer5 = ::fast_io::u8string_view{u8"<h2>text<h2>text</h2></h2>"};
    ::pltxt2htm_test::assert_true(html5 == answer5);

    auto html6 = ::pltxt2htm_test::pltxt2advanced_htmld(u8"<h2>");
