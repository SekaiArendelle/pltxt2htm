...
int main() noexcept {
    auto html1 = ::pltxt2htm::pltxt2html(u8"<cOLOr=red>text</color>");
    auto answer1 = u8"<span style=\"color:red;\">text</span>";
    ::exception::assert_true(::std::memcmp(html1.data(), answer1, html1.size()) == 0);

    auto html2 = ::pltxt2htm::pltxt2html(u8"<color=#66CcFf      >text</color   >");
...
<color=#66CcFf>te
 xt</color>
    ...
    auto html5 = ::pltxt2htm::pltxt2html(u8"<color=red><Color=#66CcFf>text</color></color>");
    ...
    auto html6 = ::pltxt2htm::pltxt2html(u8"test<Color=#66CcFf>");
    auto answer6 = u8"test";
    ::exception::assert_true(::std::memcmp(html6.data(), answer6, html6.size()) == 0);

    auto html7 = ::pltxt2htm::pltxt2html(u8"test<Color=#66CcFf>text");
