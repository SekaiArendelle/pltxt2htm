...
int main() noexcept {
    auto html1 = ::pltxt2htm::pltxt2html(u8"<a>text</a>", u8"localhost:5173");
...
<A      >text
    ...
    auto html3 = ::pltxt2htm::pltxt2html(u8"<A      >text</a   >", u8"localhost:5173");
    auto answer3 = u8"<span style=\"color:#0000AA;\">text</span>";
    ::exception::assert_true(::std::memcmp(html3.data(), answer3, html3.size()) == 0);

    auto html4 = ::pltxt2htm::pltxt2html(u8"<a>text</a><color=red>text</color>", u8"localhost:5173");
