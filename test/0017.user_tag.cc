...
int main() noexcept {
    ...
    auto html2 =
        ::pltxt2htm::pltxt2html(u8"<USER=642cf37a494746375aae306a      >physicsLab</USER      >", u8"localhost:5173");
    auto answer2 =
        ::fast_io::u8string_view{u8"<span class=\'RUser\' data-user=\'642cf37a494746375aae306a\'>physicsLab</span>"};
...
<User=642cf37a494746375aae306a      >te
 xt</user      >
    ...
    auto html5 = ::pltxt2htm::pltxt2html(u8"<User=123><user=642cf37a494746375aae306a>physicsLab</user></User>",
                                         u8"localhost:5173");
    auto answer5 =
        ::fast_io::u8string_view{u8"<span class=\'RUser\' data-user=\'642cf37a494746375aae306a\'>physicsLab</span>"};
    ::exception::assert_true(html5 == answer5);

    auto html6 = ::pltxt2htm::pltxt2html(u8"test<User=123>", u8"localhost:5173");
    auto answer6 = ::fast_io::u8string_view{u8"test"};
    ::exception::assert_true(html6 == answer6);

    // test invalid tag
    auto html8 = ::pltxt2htm::pltxt2html(u8"test<user=", u8"localhost:5173");
    ...
    auto html10 = ::pltxt2htm::pltxt2html(u8"<user=642cf37a494746375aae306a>physics<user=123>L</user>ab</user>",
                                          u8"localhost:5173");
