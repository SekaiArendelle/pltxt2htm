...
int main() {
    static_assert(::std::is_copy_constructible_v<::pltxt2htm::HeapGuard<::pltxt2htm::NodeType>>);
    static_assert(::std::movable<::pltxt2htm::HeapGuard<::pltxt2htm::NodeType>>);

    ::pltxt2htm::Ast text{};
    text.push_back(::pltxt2htm::HeapGuard<::pltxt2htm::U8Char>{u8't'});
    text.push_back(::pltxt2htm::HeapGuard<::pltxt2htm::U8Char>{u8'e'});
    text.push_back(::pltxt2htm::HeapGuard<::pltxt2htm::U8Char>{u8's'});
    text.push_back(::pltxt2htm::HeapGuard<::pltxt2htm::U8Char>{u8't'});
