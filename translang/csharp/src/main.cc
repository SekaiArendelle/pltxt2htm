...
#include "../include/api_instantiaation_visitor.hh"
...
struct TranslationModel {
    ::std::string api_instantiation_csharp{};
...
constexpr auto generate_csharp(TranslationModel const& model) -> ::std::string {
    ...
    out << "{\n";
    out << model.api_instantiation_csharp;
...
[[nodiscard]]
constexpr auto build_clang_args() -> ::std::vector<::std::string> {
...
#if defined(NDEBUG)
template auto ::pltxt2htm::pltxt2advanced_html<::pltxt2htm::Contracts::ignore, true>(::fast_io::u8string_view);
template auto ::pltxt2htm::pltxt2fixedadv_html<::pltxt2htm::Contracts::ignore, true>(
    ::fast_io::u8string_view, ::fast_io::u8string_view, ::fast_io::u8string_view, ::fast_io::u8string_view,
    ::fast_io::u8string_view, ::fast_io::u8string_view);
template auto ::pltxt2htm::pltxt2plunity_introduction<::pltxt2htm::Contracts::ignore, true>(
    ::fast_io::u8string_view, ::fast_io::u8string_view, ::fast_io::u8string_view, ::fast_io::u8string_view,
    ::fast_io::u8string_view);
template auto ::pltxt2htm::pltxt2common_html<::pltxt2htm::Contracts::ignore, false>(::fast_io::u8string_view);
#else
template auto ::pltxt2htm::pltxt2advanced_html<::pltxt2htm::Contracts::quick_enforce, true>(::fast_io::u8string_view);
template auto ::pltxt2htm::pltxt2fixedadv_html<::pltxt2htm::Contracts::quick_enforce, true>(
    ::fast_io::u8string_view, ::fast_io::u8string_view, ::fast_io::u8string_view, ::fast_io::u8string_view,
    ::fast_io::u8string_view, ::fast_io::u8string_view);
template auto ::pltxt2htm::pltxt2plunity_introduction<::pltxt2htm::Contracts::quick_enforce, true>(
    ::fast_io::u8string_view, ::fast_io::u8string_view, ::fast_io::u8string_view, ::fast_io::u8string_view,
    ::fast_io::u8string_view);
template auto ::pltxt2htm::pltxt2common_html<::pltxt2htm::Contracts::quick_enforce, false>(
    ::fast_io::u8string_view);
#endif
)"};
    ...
    ApiInstantiationVisitor api_visitor{};
    api_visitor.TraverseDecl(translation_unit);
    model.api_instantiation_csharp = api_visitor.csharp_code();
    if (model.api_instantiation_csharp.empty()) {
        return ::llvm::createStringError(::std::errc::invalid_argument,
                                         "no C# stubs were generated from template instantiation AST");
    }
