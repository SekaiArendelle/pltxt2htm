...
int main() {
    {
        ...
        ::pltxt2htm_test::assert_true(::pltxt2htm::details::try_parse_url<::pltxt2htm::Contracts::quick_enforce>(url).has_value());
    }
    {
    ...
    }
    {
        ...
        ::pltxt2htm_test::assert_true(::pltxt2htm::details::try_parse_url<::pltxt2htm::Contracts::quick_enforce>(url).has_value() == false);
    }
    {
    ...
    {
        auto url = ::fast_io::u8string_view{u8"https://www.example.com:"};
        ::pltxt2htm_test::assert_true(::pltxt2htm::details::try_parse_url<::pltxt2htm::Contracts::quick_enforce, true>(url).has_value() == false);
    }
    {
    ...
    {
        auto url = ::fast_io::u8string_view{u8"https://www.example.com:80)"};
        ::pltxt2htm_test::assert_true(::pltxt2htm::details::try_parse_url<::pltxt2htm::Contracts::quick_enforce, true>(url).has_value() == true);
    }
    {
    ...
    {
        ::pltxt2htm_test::assert_true(::pltxt2htm::details::try_parse_url<::pltxt2htm::Contracts::quick_enforce, true>(u8"image.gif)").has_value() ==
                                      false);
    }
    {
        ::pltxt2htm_test::assert_true(::pltxt2htm::details::try_parse_url<::pltxt2htm::Contracts::quick_enforce, true>(u8"example.com)").has_value() ==
                                      true);
    }
