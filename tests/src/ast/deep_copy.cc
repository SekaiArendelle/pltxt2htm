...
int main() {
    ...
    // Copy a Text node
    {
        auto const original = ::pltxt2htm::PlTxtNode<nd::quick_enforce>(::pltxt2htm::Text<nd::quick_enforce>{u8'X'});
        auto const copy = original;
        pltxt2htm_test_assert_true(original == copy);
    }
    ...
    // Deep copy a simple Group node with children
    {
        ...
        ast.emplace_back(::pltxt2htm::Text<nd::quick_enforce>{u8'i'});
    ...
    // Deep copy with nested sub-AST (HtmlBlockquote > HtmlH1 > Text)
    {
        ...
        inner.emplace_back(::pltxt2htm::Text<nd::quick_enforce>{u8'a'});
    ...
    {
        ::pltxt2htm::Ast<nd::quick_enforce> ast{};
        ast.emplace_back(::pltxt2htm::Text<nd::quick_enforce>{u8'c'});
    ...
    {
        ::pltxt2htm::Ast<nd::quick_enforce> ast{};
        ast.emplace_back(::pltxt2htm::Text<nd::quick_enforce>{u8'x'});
    ...
    // Copy of a node with Url (MdLink)
    {
        ...
        text_ast.emplace_back(::pltxt2htm::Text<nd::quick_enforce>{u8't'});
    ...
    // Ast copy independence
    {
        ...
        original.emplace_back(::pltxt2htm::Text<nd::quick_enforce>{u8'A'});

        auto copy = original;

        original.clear();
        original.emplace_back(::pltxt2htm::Text<nd::quick_enforce>{u8'B'});

        ::pltxt2htm::Ast<nd::quick_enforce> expected{};
        expected.emplace_back(::pltxt2htm::Text<nd::quick_enforce>{u8'A'});
