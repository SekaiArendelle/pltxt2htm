...
TEST_SUITE("md_ul_list") {
    ...
    TEST_CASE("---- nested different markers in child ----") {
        auto html = ::pltxt2htm_test::pltxt4unittest(u8"- a\n  - b\n  + c");
    ...
    TEST_CASE("---- alternating text and single-item lists ----") {
        auto html = ::pltxt2htm_test::pltxt4unittest(u8"a\n- 1\nb\n- 2\nc\n- 3");
    ...
    TEST_CASE("---- emphasis inside list ----") {
    ...
    TEST_CASE("stray </li>) is rejected by the HTML list scanner and th...") {
