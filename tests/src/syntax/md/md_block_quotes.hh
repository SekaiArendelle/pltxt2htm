...
TEST_SUITE("md_block_quotes") {
    ...
    TEST_CASE("heading-then-quote") {
        auto html = ::pltxt2htm_test::pltxt4unittest(u8"# \n> quote");
        auto const& answer = u8"<h1></h1><blockquote>quote</blockquote>";
        CHECK(html == answer);
    }

    TEST_CASE("thematic-break-then-quote") {
        auto html = ::pltxt2htm_test::pltxt4unittest(u8"---\n> quote");
