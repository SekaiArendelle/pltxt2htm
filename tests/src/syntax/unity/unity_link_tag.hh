...
TEST_SUITE("unity_link_tag") {
    TEST_CASE("<link=/'https://example.com/discussion/'>physicslab</lin...") {
    ...
    TEST_CASE("<lInK=/'https://another-example.org/path/'>physicslab</L...") {
    ...
    TEST_CASE("<LINK='https://site.com/item' >te") {
...
<LINK="https://site.com/item"      >te
 xt</link      >
    ...
    TEST_CASE("<Link=/'https://main.com/'><link=/'https://nested.com/'>...") {
        auto html = ::pltxt2htm_test::pltxt4unittest(
    ...
    TEST_CASE("A bare URL in a link tag's text is not auto-linked (no n...") {
    ...
    TEST_CASE("Same suppression applies inside pl_external.") {
    ...
    TEST_CASE("Control: outside any URL-link frame auto-link still work...") {
    ...
    TEST_CASE("ab<Link=/'https://first.com/'>te<link=/'https://second.c...") {
        auto html = ::pltxt2htm_test::pltxt4unittest(
    ...
    TEST_CASE("unquoted value is not a Unity TextMeshPro link tag; with...") {
    ...
    TEST_CASE("<link=/'https://example.com/'>text<link=/'https://anothe...") {
        auto html = ::pltxt2htm_test::pltxt4unittest(
    ...
    TEST_CASE("<link=/'https://example.com/'>physics<link=/'https://ano...") {
        auto html = ::pltxt2htm_test::pltxt4unittest(
    ...
    TEST_CASE("<link=/'https://example.com/'>physicslab") {
    ...
    TEST_CASE("t<link=/'https://example.com/'></link>t") {
    ...
    TEST_CASE("<link=/'https://example.com/'></link") {
    ...
    TEST_CASE("<link=/'https://main.com/'><i><link=/'https://nested.com...") {
        auto html = ::pltxt2htm_test::pltxt4unittest(
    ...
    TEST_CASE("<link=/'javascript:alert(1)/'>x</link>") {
    ...
    TEST_CASE("<link=/'https://main.com/'><i><experiment=a>c</experimen...") {
        auto html =
    ...
    TEST_CASE("<link=/'https://main.com/'><i><discussion=a>c</discussio...") {
        auto html =
    ...
    TEST_CASE("Same as above: rejected at the root; so the URL is auto-...") {
    ...
    TEST_CASE("<link=/'javascript:alert('XSS')/'>clickme</link>") {
    ...
    TEST_CASE("--- rejected <link='...'> tags (recognized structure; in...") {
    ...
    TEST_CASE("'&amp;' inside the rejected span stays an entity (no dou...") {
    ...
    TEST_CASE("macros inside the rejected span are not expanded") {
    ...
    TEST_CASE("backslash escapes are still processed inside the rejecte...") {
    ...
    TEST_CASE("markdown link syntax inside the rejected span is not int...") {
    ...
    TEST_CASE("the PLUnity backend escapes the rejected span's angle br...") {
    ...
    TEST_CASE("non-ASCII (CJK) in the link path is accepted and percent...") {
