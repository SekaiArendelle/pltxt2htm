...
TEST_SUITE("pl_discussions_tag") {
    ...
    TEST_CASE("<discussions=UserID/abc/UserName//u5C0F/u660E>/u66F4/u59...") {
    ...
    TEST_CASE("<discussions=a>t<experiment=b>ex</experiment>t</discussi...") {
    ...
    TEST_CASE("plunity backend keeps the list-entry tag verbatim (see f...") {
