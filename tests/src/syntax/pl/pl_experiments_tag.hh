...
TEST_SUITE("pl_experiments_tag") {
    ...
    TEST_CASE("web backend escapes the list-entry tag (per feature requ...") {
    ...
    TEST_CASE("<experiments=UserID/abc/UserName//u5C0F/u660E>/u66F4/u59...") {
        auto html = ::pltxt2htm_test::pltxt4unittest(
    ...
    TEST_CASE("comma-separated multi-values are allowed") {
    ...
    TEST_CASE("case-insensitive tag name") {
    ...
    TEST_CASE("empty content is removed by the optimizer") {
    ...
    TEST_CASE("unmatched closing tag is tolerated") {
    ...
    TEST_CASE("value characters that could enable XSS are escaped on ou...") {
    ...
    TEST_CASE("non-nestable mutual exclusion with singular tags: inner...") {
    ...
    TEST_CASE("<experiments=a>t<discussion=b>ex</discussion>t</experime...") {
    ...
    TEST_CASE("plunity backend keeps the list-entry tag verbatim") {
    ...
    TEST_CASE("<experiments=abc>list</experiments>") {
