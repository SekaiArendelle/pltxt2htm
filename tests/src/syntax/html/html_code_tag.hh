...
TEST_SUITE("html_code_tag") {
    ...
    TEST_CASE("bare <code> renders as an inline <code> element (like ot...") {
    ...
    TEST_CASE("opening and closing tags allow spaces before '>' (case-i...") {
        auto html = ::pltxt2htm_test::pltxt4unittest(u8"<CODE    >text</CODE  >");
        auto const& answer = u8"<code>text</code>";
        CHECK(html == answer);
    }
    ...
    TEST_CASE("content is parsed as inline markup (nested tags are proc...") {
    ...
    TEST_CASE("<code><color=red>text</code></color>") {
    ...
    TEST_CASE("nested <code> is flattened (same-tag optimization; like...") {
    ...
    TEST_CASE("unclosed <code> auto-closes at end of input; empty conte...") {
    ...
    TEST_CASE("incomplete <code (no '>') stays literal escaped text") {
        auto html = ::pltxt2htm_test::pltxt4unittest(u8"<code");
    ...
    TEST_CASE("empty <code></code> is dropped") {
    ...
    TEST_CASE("--- standalone <code class='language-...'> stays literal...") {
    ...
    TEST_CASE("<code class=/'language-cpp/'>fn()</code>") {
    ...
    TEST_CASE("<code class='language-c++'>fn()</code>") {
    ...
    TEST_CASE("unknown attribute (style)") {
    ...
    TEST_CASE("language- with empty language suffix") {
    ...
    TEST_CASE("attribute injection attempts stay escaped") {
    ...
    TEST_CASE("ab<code>test</code>cd") {
    ...
    TEST_CASE("<code class=/'language-cpp/'>code</code>") {
