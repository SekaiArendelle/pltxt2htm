...
TEST_SUITE("html_h2_tag") {
    ...
    TEST_CASE("<h2><color=red>text</color></h2>") {
    ...
    TEST_CASE("<h2><color=red>text</h2></color>") {
    ...
    TEST_CASE("<h2>text<h2>text</h2></h2>") {
    ...
    TEST_CASE("text<br><h2>text</h2> (13)") {
        auto const& pltext = u8"text<br><h2>text</h2>";
