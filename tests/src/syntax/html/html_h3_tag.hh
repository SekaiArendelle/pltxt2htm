...
TEST_SUITE("html_h3_tag") {
    ...
    TEST_CASE("<h3><color=red>text</color></h3>") {
    ...
    TEST_CASE("<h3><color=red>text</h3></color>") {
    ...
    TEST_CASE("<h3>text<h3>text</h3></h3>") {
    ...
    TEST_CASE("text<br><h3>text</h3> (13)") {
        auto const& pltext = u8"text<br><h3>text</h3>";
