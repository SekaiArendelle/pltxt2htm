...
TEST_SUITE("html_h1_tag") {
    ...
    TEST_CASE("<h1><color=red>text</color></h1>") {
    ...
    TEST_CASE("<h1><color=red>text</h1></color>") {
    ...
    TEST_CASE("<h1>text<h1>text</h1></h1>") {
    ...
    TEST_CASE("text<br><h1>text</h1> (14)") {
        auto const& pltext = u8"text<br><h1>text</h1>";
