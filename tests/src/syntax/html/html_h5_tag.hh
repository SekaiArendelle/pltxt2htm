...
TEST_SUITE("html_h5_tag") {
    ...
    TEST_CASE("<h5><color=red>text</color></h5>") {
    ...
    TEST_CASE("<h5><color=red>text</h5></color>") {
    ...
    TEST_CASE("<h5>text<h5>text</h5></h5>") {
    ...
    TEST_CASE("text<br><h5>text</h5> (13)") {
        auto const& pltext = u8"text<br><h5>text</h5>";
