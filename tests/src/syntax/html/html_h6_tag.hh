...
TEST_SUITE("html_h6_tag") {
    ...
    TEST_CASE("<h6><color=red>text</color></h6>") {
    ...
    TEST_CASE("<h6><color=red>text</h6></color>") {
    ...
    TEST_CASE("<h6>text<h6>text</h6></h6>") {
    ...
    TEST_CASE("<h6></h6") {
        ...
        CHECK(html == answer);
        auto plunity_richtext = ::pltxt2htm_test::pltxt2plunity_introduction(pltext);
        auto const& plunity_richtext_answer = u8"<b><size=20>\uFF1C</size>/h6</b>\n";
        CHECK(plunity_richtext == plunity_richtext_answer);
    }
    ...
    TEST_CASE("# <h6>text") {
        ...
        auto plunity_richtext = ::pltxt2htm_test::pltxt2plunity_introduction(pltext);
        auto const& plunity_richtext_answer =
            u8"<size=38><b><size=20>\uFF1C</size>h6<size=20>\uFF1E</size>text</b></size>\n";
        CHECK(plunity_richtext == plunity_richtext_answer);
    }
    ...
    TEST_CASE("t<h6></h6") {
        ...
        auto plunity_richtext = ::pltxt2htm_test::pltxt2plunity_introduction(pltext);
        auto const& plunity_richtext_answer =
            u8"t<size=20>\uFF1C</size>h6<size=20>\uFF1E</size><size=20>\uFF1C</size>/h6";
        CHECK(plunity_richtext == plunity_richtext_answer);
    }

    TEST_CASE("<h6>text</h5>text</h6></h6>") {
    ...
    TEST_CASE("text<br><h6>text</h6> (14)") {
        auto const& pltext = u8"text<br><h6>text</h6>";
