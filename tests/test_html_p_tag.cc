...
int main() {
...

    {
        ...
        auto html = ::pltxt2htm_test::pltxt4unittest(pltext);
        auto answer = ::fast_io::u8string_view{u8"text<p style=\"text-align:left\">text</p>"};
        pltxt2htm_test_assert_equal(html, answer);
        auto plunity_richtext = ::pltxt2htm_test::pltxt2plunity_introduction(pltext);
        auto plunity_richtext_answer = ::fast_io::u8string_view{u8"text\ntext"};
        pltxt2htm_test_assert_equal(plunity_richtext, plunity_richtext_answer);
    ...
    // newline separates two block-level <p> tags
    {
        ...
        auto html = ::pltxt2htm_test::pltxt4unittest(pltext);
        auto answer =
            ::fast_io::u8string_view{u8"<p style=\"text-align:left\">a</p><p style=\"text-align:left\">b</p>"};
        pltxt2htm_test_assert_equal(html, answer);
        auto plunity_richtext = ::pltxt2htm_test::pltxt2plunity_introduction(pltext);
    ...
    // multiple blank lines render as multiple <br>
    {
        ...
        auto html = ::pltxt2htm_test::pltxt4unittest(pltext);
        auto answer = ::fast_io::u8string_view{
            u8"<p style=\"text-align:left\">a</p><br><br><p style=\"text-align:left\">b</p>"};
        pltxt2htm_test_assert_equal(html, answer);
    }
    ...
    // trailing text after a closing </p> starts a new line
    {
        ...
        auto html = ::pltxt2htm_test::pltxt4unittest(pltext);
        auto answer =
            ::fast_io::u8string_view{u8"<p style=\"text-align:left\">a</p>text<p style=\"text-align:left\">b</p>"};
        pltxt2htm_test_assert_equal(html, answer);
        auto plunity_richtext = ::pltxt2htm_test::pltxt2plunity_introduction(pltext);
        auto plunity_richtext_answer = ::fast_io::u8string_view{u8"a\ntext\nb"};
        pltxt2htm_test_assert_equal(plunity_richtext, plunity_richtext_answer);
    ...
    // text after a newline followed by a <p> block
    {
        ...
        auto html = ::pltxt2htm_test::pltxt4unittest(pltext);
        auto answer = ::fast_io::u8string_view{
            u8"<p style=\"text-align:left\">a</p><br>text<p style=\"text-align:left\">b</p>"};
        pltxt2htm_test_assert_equal(html, answer);
    }
    ...
    // a leading newline before a <p> block
    {
        ...
        auto html = ::pltxt2htm_test::pltxt4unittest(pltext);
        auto answer = ::fast_io::u8string_view{u8"<p style=\"text-align:left\">a</p>"};
        pltxt2htm_test_assert_equal(html, answer);
    }
    ...
    // an unclosed <p> at a line start still forms a block containing the newline
    {
        ...
        auto html = ::pltxt2htm_test::pltxt4unittest(pltext);
        auto answer =
            ::fast_io::u8string_view{u8"<p style=\"text-align:left\">a<p style=\"text-align:left\">b</p></p>"};
        pltxt2htm_test_assert_equal(html, answer);
        auto plunity_richtext = ::pltxt2htm_test::pltxt2plunity_introduction(pltext);
        auto plunity_richtext_answer = ::fast_io::u8string_view{u8"a\nb"};
        pltxt2htm_test_assert_equal(plunity_richtext, plunity_richtext_answer);
...

    {
        ...
        pltxt2htm_test_assert_equal(html, answer);
        auto plunity_richtext = ::pltxt2htm_test::pltxt2plunity_introduction(pltext);
        auto plunity_richtext_answer = ::fast_io::u8string_view{u8"<align=right>text</align>"};
        pltxt2htm_test_assert_equal(plunity_richtext, plunity_richtext_answer);
    }

    {
        ...
        pltxt2htm_test_assert_equal(html, answer);
        auto plunity_richtext = ::pltxt2htm_test::pltxt2plunity_introduction(pltext);
        auto plunity_richtext_answer = ::fast_io::u8string_view{u8"<align=justified>text</align>"};
        pltxt2htm_test_assert_equal(plunity_richtext, plunity_richtext_answer);
    }
    ...
    {
        auto pltext = ::fast_io::u8string_view{u8"<p style=\"text-align:center\"><b>text</b></p>"};
        auto html = ::pltxt2htm_test::pltxt4unittest(pltext);
        auto answer = ::fast_io::u8string_view{u8"<p style=\"text-align:center\"><strong>text</strong></p>"};
        pltxt2htm_test_assert_equal(html, answer);
        auto plunity_richtext = ::pltxt2htm_test::pltxt2plunity_introduction(pltext);
        auto plunity_richtext_answer = ::fast_io::u8string_view{u8"<align=center><b>text</b></align>"};
        pltxt2htm_test_assert_equal(plunity_richtext, plunity_richtext_answer);
    }
