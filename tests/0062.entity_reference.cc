...
int main() {
    ...
    }
    {
        ...
        auto result = ::pltxt2htm::details::try_parse_entity_reference<::pltxt2htm::Contracts::quick_enforce>(text.subview(3));
        ::pltxt2htm_test::assert_true(result.has_value() && result.value() == 5);
    }

    {
        ...
        ::pltxt2htm_test::assert_true(
            ::pltxt2htm::details::try_parse_entity_reference<::pltxt2htm::Contracts::quick_enforce>(text).has_value() == false);
    }
    {
        auto text = ::fast_io::u8string_view{u8"&amp"};
        ::pltxt2htm_test::assert_true(
