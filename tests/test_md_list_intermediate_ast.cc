...
int main() {
    {
        ...
        ::pltxt2htm::details::assert_true<::pltxt2htm::Contracts::quick_enforce>(node1 == node2);
    }
    {
    ...
    }
    {
        ...
        ::pltxt2htm::details::ListUlNode<::pltxt2htm::Contracts::quick_enforce> ul_node{
            ::pltxt2htm::details::ListAst<::pltxt2htm::Contracts::quick_enforce>{}};
        ::pltxt2htm::details::assert_false<::pltxt2htm::Contracts::quick_enforce>(
    ...
    }
    {
        ...
        ::pltxt2htm::details::assert_true<::pltxt2htm::Contracts::quick_enforce>(ast1 == ast2);
    }
    {
        auto ast1 = md_list(text_item(u8"test"));
        auto ast2 = md_list(text_item(u8"text"));
        ::pltxt2htm::details::assert_false<::pltxt2htm::Contracts::quick_enforce>(ast1 == ast2);
    }
    {
        auto ast1 = md_list(
        ...
        auto ast3 = md_list(
            ...
            ul_item(text_item(u8"test"), text_item(u8"test"), ul_item(text_item(u8"test"), text_item(u8"test"))));
        ::pltxt2htm::details::assert_false<::pltxt2htm::Contracts::quick_enforce>(ast1 == ast2);
        ::pltxt2htm::details::assert_true<::pltxt2htm::Contracts::quick_enforce>(ast1 == ast3);
    }
    {
        ...
        ::pltxt2htm::details::assert_true<::pltxt2htm::Contracts::quick_enforce>(result.top_node == answer);
    }
    {
        auto result =
    ...
    }
    {
        ...
        ::pltxt2htm::details::assert_false<::pltxt2htm::Contracts::quick_enforce>(ast.has_value());
    }
    {
        auto ast = ::pltxt2htm::details::optionally_to_md_list_ast<::pltxt2htm::Contracts::quick_enforce>(u8" -");
        ::pltxt2htm::details::assert_false<::pltxt2htm::Contracts::quick_enforce>(ast.has_value());
    ...
    {
        auto ast = ::pltxt2htm::details::optionally_to_md_list_ast<::pltxt2htm::Contracts::quick_enforce>(u8" - ");
        ::pltxt2htm::details::assert_true<::pltxt2htm::Contracts::quick_enforce>(ast.has_value());
    }
    {
        auto ast = ::pltxt2htm::details::optionally_to_md_list_ast<::pltxt2htm::Contracts::quick_enforce>(u8"   ");
        ::pltxt2htm::details::assert_false<::pltxt2htm::Contracts::quick_enforce>(ast.has_value());
    ...
    }
    {
        ...
        ::pltxt2htm::details::assert_true<::pltxt2htm::Contracts::quick_enforce>(
            ast.value<::pltxt2htm::Contracts::quick_enforce>().top_node == answer);
    }
    {
        auto ast = ::pltxt2htm::details::optionally_to_md_list_ast<::pltxt2htm::Contracts::quick_enforce>(u8" - ");
...

    {
        ...
        auto result = ::pltxt2htm::details::optionally_to_md_list_ast<::pltxt2htm::Contracts::quick_enforce>(
            u8"3. test\n 4. test");
        ::pltxt2htm::details::assert_true<::pltxt2htm::Contracts::quick_enforce>(
            result.value<::pltxt2htm::Contracts::quick_enforce>().top_node.get_start() == 3);
    }
    {
    ...
    }
    {
        ...
        auto result = ::pltxt2htm::details::optionally_to_md_list_ast<::pltxt2htm::Contracts::quick_enforce>(
            u8"5) test\n 6) test");
        ::pltxt2htm::details::assert_true<::pltxt2htm::Contracts::quick_enforce>(
            result.value<::pltxt2htm::Contracts::quick_enforce>().top_node.get_start() == 5);
    }
    {
        ...
        auto result =
            ::pltxt2htm::details::optionally_to_md_list_ast<::pltxt2htm::Contracts::quick_enforce>(u8"- text\n - text");
        ::pltxt2htm::details::assert_true<::pltxt2htm::Contracts::quick_enforce>(
            result.value<::pltxt2htm::Contracts::quick_enforce>().top_node.get_type() ==
