...
BENCHMARK_DEFINE_F(MicroFixture, NodeCreate_Text)(benchmark::State& st) {
    for (auto _ : st) {
        ::pltxt2htm::PlTxtNode<ndebug> node{::pltxt2htm::Text<ndebug>{u8'A'}};
...
BENCHMARK_DEFINE_F(MicroFixture, NodeCreate_Group)(benchmark::State& st) {
    for (auto _ : st) {
        ...
        sub.push_back(::pltxt2htm::PlTxtNode<ndebug>{::pltxt2htm::Text<ndebug>{u8'A'}});
...
BENCHMARK_DEFINE_F(MicroFixture, NodeCreate_UnityColor)(benchmark::State& st) {
    for (auto _ : st) {
        ::pltxt2htm::Ast<ndebug> sub;
        sub.push_back(::pltxt2htm::PlTxtNode<ndebug>{::pltxt2htm::Text<ndebug>{u8't'}});
...
BENCHMARK_DEFINE_F(MicroFixture, NodeCreate_MdLink)(benchmark::State& st) {
    for (auto _ : st) {
        ...
        text_sub.push_back(::pltxt2htm::PlTxtNode<ndebug>{::pltxt2htm::Text<ndebug>{u8'L'}});
...
BENCHMARK_DEFINE_F(MicroFixture, NodeMove_Trivial)(benchmark::State& st) {
    ::pltxt2htm::PlTxtNode<ndebug> src{::pltxt2htm::Text<ndebug>{u8'A'}};
    for (auto _ : st) {
...
BENCHMARK_DEFINE_F(MicroFixture, NodeMove_WithSubAst)(benchmark::State& st) {
    ...
    nested.push_back(::pltxt2htm::PlTxtNode<ndebug>{::pltxt2htm::Text<ndebug>{u8'A'}});
    nested.push_back(::pltxt2htm::PlTxtNode<ndebug>{::pltxt2htm::Text<ndebug>{u8'B'}});
...
BENCHMARK_DEFINE_F(MicroFixture, AstAppend_1000)(benchmark::State& st) {
    for (auto _ : st) {
        ...
        for (int i = 0; i < 1000; ++i) {
            ast.push_back(::pltxt2htm::PlTxtNode<ndebug>{::pltxt2htm::Text<ndebug>{u8'A'}});
        }
