 ...
 * @note Only handles the `<p>`, `<h1>`–`<h6>`, `<blockquote>`, `<ul>`, and `<ol>` blocks for now; other block elements are out of scope for the html parser.
 */
...
constexpr auto find_next_block_after_line_break(
    ...
    if (auto opt_ul_tag_len = ::pltxt2htm::details::try_parse_bare_tag<ndebug, u8"<ul">(pltext);
        opt_ul_tag_len.has_value()) {
        ::std::size_t const consumed{opt_ul_tag_len.template value<ndebug == ::pltxt2htm::Contracts::ignore>() + 1};
        call_stack.push(::pltxt2htm::details::ParserFrameContext<ndebug>(
            ::pltxt2htm::details::FrontendContextVariant<ndebug>{
                ::pltxt2htm::details::ParserFrameContextWithPltextInfo{
                    ::pltxt2htm::details::u8string_view_subview<ndebug>(pltext, consumed)},
    ...
    if (auto opt_ol_tag_len = ::pltxt2htm::details::try_parse_bare_tag<ndebug, u8"<ol">(pltext);
        opt_ol_tag_len.has_value()) {
        ::std::size_t const consumed{opt_ol_tag_len.template value<ndebug == ::pltxt2htm::Contracts::ignore>() + 1};
        call_stack.push(::pltxt2htm::details::ParserFrameContext<ndebug>(
            ::pltxt2htm::details::FrontendContextVariant<ndebug>{
                ::pltxt2htm::details::ParserFrameContextWithPltextInfo{
                    ::pltxt2htm::details::u8string_view_subview<ndebug>(pltext, consumed)},
