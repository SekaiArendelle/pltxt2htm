...
public:
    ...
    OptimizerFrameContext(::pltxt2htm::Ast<ndebug>* ast_, ::pltxt2htm::NodeType const nested_tag_type_,
                          Iter&& iter_) noexcept
    ...
    OptimizerFrameContext(::pltxt2htm::Ast<ndebug>* ast_, ::pltxt2htm::NodeType const nested_tag_type_, Iter&& iter_,
