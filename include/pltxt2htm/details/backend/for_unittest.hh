...
[[__gnu__::__pure__]]
#endif
constexpr auto unittest_backend(::pltxt2htm::Ast const& ast_init) noexcept -> ::fast_io::u8string {
...
entry:
    ...
    for (; current_index < ast.size(); ++current_index) {
        ...
        case ::pltxt2htm::NodeType::pl_experiment: {
            ...
            ++current_index;
            result.append(u8"<a href=\"localhost:5173/ExperimentSummary/Experiment/");
        ...
        case ::pltxt2htm::NodeType::pl_discussion: {
            ...
            ++current_index;
            result.append(u8"<a href=\"localhost:5173/ExperimentSummary/Discussion/");
