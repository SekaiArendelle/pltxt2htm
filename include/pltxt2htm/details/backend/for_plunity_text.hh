...
entry:
    ...
    for (; current_index < ast.size(); ++current_index) {
        ...
        case ::pltxt2htm::NodeKind::md_del: {
            call_stack.push(
                ::pltxt2htm::details::BackendFrameContext<ndebug>(node.get_subast(), ::pltxt2htm::NodeKind::md_del, 0));
            ++current_index;
            result.append(u8"~~");
            goto entry;
        }
        ...
        case ::pltxt2htm::NodeKind::md_code_span_3_backtick: {
            call_stack.push(::pltxt2htm::details::BackendFrameContext<ndebug>(
                node.get_subast(), ::pltxt2htm::NodeKind::md_code_span_1_backtick, 0));
            ++current_index;
            result.push_back(u8' ');
            goto entry;
        }
        ...
        case ::pltxt2htm::NodeKind::md_block_quotes: {
            call_stack.push(::pltxt2htm::details::BackendFrameContext<ndebug>(
                node.get_subast(), ::pltxt2htm::NodeKind::md_block_quotes, 0));
            ++current_index;
            goto entry;
        }
