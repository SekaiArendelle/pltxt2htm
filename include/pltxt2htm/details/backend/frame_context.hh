...
public:
    ::pltxt2htm::PlAst const& ast_; ///< Reference to the AST being processed
private:
...
public:
    ...
    constexpr BackendBasicFrameContext(::pltxt2htm::PlAst const& ast, ::pltxt2htm::NodeType const nested_tag_type,
