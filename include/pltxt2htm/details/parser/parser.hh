    ...
    while (true) {
        ...
        if (auto opt_md_atx_heading =
            ...
            case ::pltxt2htm::NodeKind::md_atx_h1: {
                result.push_back(::pltxt2htm::PlTxtNode<ndebug>::template emplace<::pltxt2htm::MdAtxH1<ndebug>>(
                    ::pltxt2htm::Ast<ndebug>{}));
                break;
            }
            case ::pltxt2htm::NodeKind::md_atx_h2: {
                result.push_back(::pltxt2htm::PlTxtNode<ndebug>::template emplace<::pltxt2htm::MdAtxH2<ndebug>>(
                    ::pltxt2htm::Ast<ndebug>{}));
                break;
            }
            case ::pltxt2htm::NodeKind::md_atx_h3: {
                result.push_back(::pltxt2htm::PlTxtNode<ndebug>::template emplace<::pltxt2htm::MdAtxH3<ndebug>>(
                    ::pltxt2htm::Ast<ndebug>{}));
                break;
            }
            case ::pltxt2htm::NodeKind::md_atx_h4: {
                result.push_back(::pltxt2htm::PlTxtNode<ndebug>::template emplace<::pltxt2htm::MdAtxH4<ndebug>>(
                    ::pltxt2htm::Ast<ndebug>{}));
                break;
            }
            case ::pltxt2htm::NodeKind::md_atx_h5: {
                result.push_back(::pltxt2htm::PlTxtNode<ndebug>::template emplace<::pltxt2htm::MdAtxH5<ndebug>>(
                    ::pltxt2htm::Ast<ndebug>{}));
                break;
            }
            case ::pltxt2htm::NodeKind::md_atx_h6: {
                result.push_back(::pltxt2htm::PlTxtNode<ndebug>::template emplace<::pltxt2htm::MdAtxH6<ndebug>>(
                    ::pltxt2htm::Ast<ndebug>{}));
                break;
            }
            default:
        ...
        if (auto opt_len = ::pltxt2htm::details::try_parse_md_thematic_break<ndebug>(
            ...
            opt_len.has_value()) {
            result.push_back(::pltxt2htm::PlTxtNode<ndebug>::template emplace<::pltxt2htm::MdHr>());
