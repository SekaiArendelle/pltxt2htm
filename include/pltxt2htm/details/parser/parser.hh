...
constexpr auto devil_stuff_after_line_break(
    ...
    ::fast_io::stack<::pltxt2htm::details::BasicFrameContext>& call_stack,
    ...
    while (true) {
        ...
        if (auto opt_md_atx_heading = ::pltxt2htm::details::try_parse_md_atx_heading<ndebug>(
            ...
            if (sublength != 0) {
                ...
                call_stack.push(
                    ::pltxt2htm::details::BasicFrameContext(subtext, md_atx_heading_type));
            ...
            call_stack.push(::pltxt2htm::details::BasicFrameContext(::std::move(subpltext)));
            return ::pltxt2htm::details::DevilStuffAfterLineBreakResult{.forward_index = current_index + forward_index,
            ...
            call_stack.push(::pltxt2htm::details::BasicFrameContext(
...
constexpr auto get_pltext_from_parser_frame_context(
    ::pltxt2htm::details::BasicFrameContext const& top_frame) noexcept
    -> ::fast_io::u8string_view {
    return top_frame.get_pltext();
}
...
constexpr auto parse_pltxt(
    ::fast_io::stack<::pltxt2htm::details::BasicFrameContext>& call_stack) noexcept
    -> ::pltxt2htm::Ast {
entry:
    if (call_stack.top()->nested_tag_type == ::pltxt2htm::NodeType::md_ul) {
        ...
        auto& frame_md_list_ast = frame->get_md_list_ast<ndebug>();
        auto& frame_iter = frame->get_md_list_iter<ndebug>();
        if (frame_iter == frame_md_list_ast.end()) {
            ::pltxt2htm::details::BasicFrameContext previous_frame(::std::move(*frame));
            call_stack.pop();
            if (call_stack.empty()) {
    ...
    while (current_index < pltext_size) {
        ...
        if (chr == u8'\n') {
            ...
            current_index += forward_index;
            call_stack.push(
                ::pltxt2htm::details::BasicFrameContext(url_text, ::std::move(url_link)));
            goto entry;
        }
            ...
            case u8'/': {
                ...
                case ::pltxt2htm::NodeType::pl_color: {
                    ...
                    if (opt_tag_len.has_value()) {
                        ...
                        ::pltxt2htm::Color staged_node(::std::move(result),
                                                       ::std::move(call_stack.top().get_equal_sign_tag_id<ndebug>()));
                        call_stack.pop();
                ...
                case ::pltxt2htm::NodeType::pl_external: {
                    ...
                    if (auto opt_tag_len = ::pltxt2htm::details::try_parse_bare_tag<ndebug, u8"external">(
                        ...
                        ::pltxt2htm::External staged_node(::std::move(result),
                                                          ::std::move(call_stack.top().get_external_tag_url<ndebug>()));
                        call_stack.pop();
                        call_stack.top()->subast.push_back(
                ...
                case ::pltxt2htm::NodeType::pl_size: {
                    ...
                    if (auto opt_tag_len = ::pltxt2htm::details::try_parse_bare_tag<ndebug, u8"size">(
                        ...
                        opt_tag_len.has_value()) {
                        ::std::size_t const staged_index{current_index};
                        ::pltxt2htm::Size staged_node(::std::move(result), call_stack.top().get_pl_size_tag_id<ndebug>());
                        call_stack.pop();
                        call_stack.top()->subast.push_back(
    ...
    {
        ::pltxt2htm::details::BasicFrameContext frame(::std::move(call_stack.top()));
        ...
        if (call_stack.empty()) {
            ...
            case ::pltxt2htm::NodeType::pl_color: {
                auto&& id = frame.get_equal_sign_tag_id<ndebug>();
            ...
            case ::pltxt2htm::NodeType::pl_external: {
                auto&& url = frame.get_external_tag_url<ndebug>();
                super_ast.push_back(
            ...
            case ::pltxt2htm::NodeType::pl_size: {
                auto&& id = frame.get_pl_size_tag_id<ndebug>();
            ...
            case ::pltxt2htm::NodeType::html_ol: {
                super_ast.push_back(::pltxt2htm::HeapGuard<::pltxt2htm::Ol>(::std::move(subast)));
                super_index += staged_index;
                goto entry;
            }
            case ::pltxt2htm::NodeType::html_li: {
            ...
            case ::pltxt2htm::NodeType::md_link: {
                auto&& link_url = frame.get_md_link_url<ndebug>();
                super_ast.push_back(
