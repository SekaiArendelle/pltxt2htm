...
constexpr ::fast_io::u8string_view c23_keywords[]{
    ...
    u8"continue",      u8"default",       u8"do",
    u8"double",        u8"else",          u8"enum",
    u8"extern",        u8"false",         u8"float",
    u8"for",           u8"goto",          u8"if",
    u8"inline",        u8"int",           u8"long",
    u8"max_align_t",   u8"nullptr",       u8"nullptr_t",
    u8"ptrdiff_t",     u8"register",      u8"restrict",
    u8"return",        u8"short",         u8"signed",
    u8"size_t",        u8"sizeof",        u8"static",
    u8"static_assert", u8"struct",        u8"switch",
    u8"thread_local",  u8"true",          u8"typedef",
    u8"typeof",        u8"typeof_unqual", u8"union",
    u8"unsigned",      u8"void",          u8"volatile",
    u8"wchar_t",       u8"while",         u8"_Alignas",
    u8"_Alignof",      u8"_Atomic",       u8"_BitInt",
    u8"_Bool",         u8"_Complex",      u8"_Decimal128",
    u8"_Decimal32",    u8"_Decimal64",    u8"_Generic",
    u8"_Imaginary",    u8"_Noreturn",     u8"_Static_assert",
    u8"_Thread_local",
};
...
constexpr ::fast_io::u8string_view cstdint_types[]{
    ...
    u8"int_fast32_t",  u8"int_fast64_t",   u8"uint_fast8_t",   u8"uint_fast16_t",  u8"uint_fast32_t", u8"uint_fast64_t",
