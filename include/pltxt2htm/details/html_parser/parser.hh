...
[[nodiscard]]
constexpr auto parse_pltxt_html(::fast_io::stack<::pltxt2htm::details::html_parser::ParserFrameContext<ndebug>>& call_stack) noexcept
...
entry:
    while (true) {
            ...
            if (chr == u8'<') {
                    ...
                    if (auto opt_a_tag = ::pltxt2htm::details::try_parse_html_a_tag<ndebug>(
                        ...
                        call_stack.push(::pltxt2htm::details::html_parser::ParserFrameContext<ndebug>(
                            ::pltxt2htm::details::html_parser::FrontendContextVariant<ndebug>{
                                ::pltxt2htm::details::html_parser::ParserFrameContextWithHtmlATagInfo<ndebug>{
                                    ::pltxt2htm::details::u8string_view_subview<ndebug>(pltext, current_index),
                ...
                case u8'S': {
                    ...
                    if (auto opt_span_tag = ::pltxt2htm::details::try_parse_span_tag<ndebug>(
                        ...
                        call_stack.push(::pltxt2htm::details::html_parser::ParserFrameContext<ndebug>(
                            ::pltxt2htm::details::html_parser::FrontendContextVariant<ndebug>{
                                ::pltxt2htm::details::html_parser::ParserFrameContextWithHtmlSpanInfo{
                                    ::pltxt2htm::details::u8string_view_subview<ndebug>(pltext, current_index),
                ...
                case u8'T': {
                    ...
                    if (auto opt_td_tag = ::pltxt2htm::details::try_parse_td_tag<ndebug>(
                        ...
                        call_stack.push(::pltxt2htm::details::html_parser::ParserFrameContext<ndebug>(
                            ::pltxt2htm::details::html_parser::FrontendContextVariant<ndebug>{
                                ::pltxt2htm::details::html_parser::ParserFrameContextWithMdCellInfo{
        ...
        {
            ::pltxt2htm::details::html_parser::ParserFrameContext<ndebug> frame(
            ...
            case ::pltxt2htm::NodeKind::html_pre: {
                parent_ast.push_back(
                    ::pltxt2htm::PlTxtNode<ndebug>(::pltxt2htm::HtmlPre<ndebug>{::std::move(subast)}));
                goto entry;
            }
            case ::pltxt2htm::NodeKind::html_blockquote: {
                parent_ast.push_back(
