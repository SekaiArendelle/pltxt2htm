    ...
    for (::std::size_t i{}; i < pltxt_size; ++i) {
        ...
        if (chr == u8'\n') {
            ...
            if ((chr & 0b1000'0000) == 0) {
                ...
                result.push_back(::std::make_unique<::pltxt2htm::U8Char>(chr));
                result.push_back(::std::make_unique<::pltxt2htm::U8Char>(::pltxt2htm::details::u8string_view_index<ndebug>(pltext, i + 1)));
                i += 1;
                ...
                result.push_back(::std::make_unique<::pltxt2htm::U8Char>(chr));
                result.push_back(::std::make_unique<::pltxt2htm::U8Char>(::pltxt2htm::details::u8string_view_index<ndebug>(pltext, i + 1)));
                result.push_back(::std::make_unique<::pltxt2htm::U8Char>(::pltxt2htm::details::u8string_view_index<ndebug>(pltext, i + 2)));
                i += 2;
                ...
                result.push_back(::std::make_unique<::pltxt2htm::U8Char>(::pltxt2htm::details::u8string_view_index<ndebug>(pltext, i + 1)));
                result.push_back(::std::make_unique<::pltxt2htm::U8Char>(::pltxt2htm::details::u8string_view_index<ndebug>(pltext, i + 2)));
                result.push_back(::std::make_unique<::pltxt2htm::U8Char>(::pltxt2htm::details::u8string_view_index<ndebug>(pltext, i + 3)));
                i += 3;
            }
        }
    }
